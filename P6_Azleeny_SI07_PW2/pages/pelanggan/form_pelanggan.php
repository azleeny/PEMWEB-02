<?php 
require_once '../../database/dbpenjualan.php';
?>
            
<form method="POST" action="proses_pelanggans.php">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="tmp_lahir" name="stok" value=""
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
        ...
        ?>
      <select id="kartu_id" name="jenis" class="custom-select">
          <?php 
